# P103 — Metallveredelung Gebrüder Wigl GmbH

## Provisional inclusion

- Process stratum: `metal_surface_heat`
- Process mapping: `PR006` — anodising; zinc-nickel; chemical nickel and galvanic coating
- SME status: `probable`; final financial and linked-enterprise review pending
- Independent human review: `PENDING`

## Sources checked

1. [Legal entity / company information](https://www.wigl-gmbh.de/)
2. [Production and process scope](https://www.wigl-gmbh.de/)
