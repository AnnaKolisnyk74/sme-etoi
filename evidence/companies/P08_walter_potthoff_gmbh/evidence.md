# P08 — Walter Potthoff GmbH

- Public brand: Walter Potthoff
- Legal entity: Walter Potthoff GmbH
- Manufacturing location: Kierspe
- Eligibility decision: EXCLUDE
- Review state: RESEARCHED

## Evidence

- `S-P08-01` confirms acquisition by Plastiflex.
- `S-P08-02` states that the enlarged group has eight production sites.
