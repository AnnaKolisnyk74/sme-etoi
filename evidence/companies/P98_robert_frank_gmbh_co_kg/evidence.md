# P98 — Robert Frank GmbH & Co. KG

## Provisional inclusion

- Process stratum: `plastics_processing`
- Process mapping: `PR001` — toolmaking; injection moulding; component assembly
- SME status: `probable`; final financial and linked-enterprise review pending
- Independent human review: `PENDING`

## Sources checked

1. [Legal entity / company information](https://www.frank-formenbau-spritzguss.de/impressum/)
2. [Production and process scope](https://www.frank-formenbau-spritzguss.de/)
