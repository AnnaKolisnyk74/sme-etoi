# P106 — Felix Vuckovic - Technische Keramik GmbH

## Provisional inclusion

- Process stratum: `glass_ceramics`
- Process mapping: `PR007` — custom technical-ceramic components; material selection and production
- SME status: `probable`; final financial and linked-enterprise review pending
- Independent human review: `PENDING`

## Sources checked

1. [Legal entity / company information](https://www.fv-technische-keramik.de/impressum/)
2. [Production and process scope](https://www.fv-technische-keramik.de/)
