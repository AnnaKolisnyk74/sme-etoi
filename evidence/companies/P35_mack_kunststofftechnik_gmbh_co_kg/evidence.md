# P35 — MACK KUNSTSTOFFTECHNIK GMBH & CO. KG
...
The checked public evidence supports **injection moulding; toolmaking and assembly**. The company is mapped to `PR001` for technical screening. This mapping does not prove a specific energy technology is installed and does not imply buying intent.
...
- `S-P35-01` — [MACK Kunststofftechnik: Impressum](https://mack-kunststoff.com/impressum/) — Exact legal entity and production location.
- `S-P35-02` — [MACK Kunststofftechnik: Kunststofftechnik](https://mack-kunststoff.com/) — Plastic-parts production process.
